...
public class BlackIPController {
	...
	@PreAuthorize("hasAuthority('ip:black:save') or hasAuthority('permission:all')")
	...
	@PreAuthorize("hasAuthority('ip:black:delete') or hasAuthority('permission:all')")
	 ...
	 * @return
	 */
	@PreAuthorize("hasAuthority('ip:black:query') or hasAuthority('permission:all')")
	@GetMapping("/blackIPs")
