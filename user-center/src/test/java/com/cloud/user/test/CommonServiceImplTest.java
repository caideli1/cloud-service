...
import com.cloud.UserCenterApplication;
...
public class CommonServiceImplTest {
    ...
    public void test() throws Exception {
        ...
        String a = mvc.perform(MockMvcRequestBuilders.get("/userLoan/ReliefItems").param("orderNo","571431343662039040").accept(MediaType.APPLICATION_JSON)).andReturn().getResponse().getContentAsString();
