...
public class ClientController {
    ...
    @PreAuthorize("hasAuthority('client:save') or hasAuthority('permission:all')")
    ...
    @PreAuthorize("hasAuthority('client:update') or hasAuthority('permission:all')")
    ...
    @PreAuthorize("hasAuthority('client:query') or hasAuthority('permission:all')")
    @GetMapping
    ...
    @PreAuthorize("hasAuthority('client:del') or hasAuthority('permission:all')")
    ...
    private boolean isSystemClient(ClientDetails clientDetails) {
        ...
        if (additionalInformation == null) {
            additionalInformation = new HashMap<>(16);
