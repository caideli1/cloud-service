...
import com.cloud.oauth.common.SecurityAuthenticationProvider;
...
//				.addFilterBefore(preAppNamePasswordFilter(), PreAppNamePasswordFilter.class)
//				.formLogin().failureHandler(failHandler).and()
