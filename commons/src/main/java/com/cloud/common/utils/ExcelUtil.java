...
import com.cloud.common.enums.ResultConvertNameEnum;
...
public class ExcelUtil {
    ...
    public static <T> List<List<Object>> createListObject(List<T> data, Set<String> keySet) throws Exception {
        List<List<Object>> rows = new ArrayList<>();

        if (CollectionUtils.isEmpty(data) || CollectionUtils.isEmpty(keySet)) {
            return rows;
        }
